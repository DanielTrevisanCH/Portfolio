...
ATP_VirtualRealityPawn_GamePad::ATP_VirtualRealityPawn_GamePad()
{
	...
	TeleportPin->SetUsingAbsoluteLocation(true);// 4.24 Update
	TeleportPin->SetUsingAbsoluteRotation(true);// 4.24 Update
	//TeleportPin->bAbsoluteLocation = true;// 4.23 Code
	//TeleportPin->bAbsoluteRotation = true;// 4.23 Code
