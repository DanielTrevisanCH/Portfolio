...
ATP_MotionController::ATP_MotionController()
{
	...
	static ConstructorHelpers::FObjectFinder<UHapticFeedbackEffect_Base> HapticEffect(TEXT("HapticFeedbackEffect_Curve'/Game/VirtualReality/Blueprints/MotionControllerHaptics'"));
	...
	ArcEndPoint->SetUsingAbsoluteLocation(true);// 4.24 Update 
	ArcEndPoint->SetUsingAbsoluteRotation(true);// 4.24 Update 
	ArcEndPoint->SetUsingAbsoluteScale(true);// 4.24 Update 
	
	//ArcEndPoint->bAbsoluteLocation = true;// 4.23 Code 
	//ArcEndPoint->bAbsoluteRotation = true;// 4.23 Code 
	//ArcEndPoint->bAbsoluteScale = true;// 4.23 Code 
	...
	ArcEndPoint->SetVisibility(false);// 4.24 Update
	//ArcEndPoint->bVisible = false;// 4.23 Code
	...
	TeleportCylinder->SetUsingAbsoluteLocation(true);// 4.24 Update 
	TeleportCylinder->SetUsingAbsoluteRotation(true);// 4.24 Update
	TeleportCylinder->SetUsingAbsoluteScale(true);// 4.24 Update
	//TeleportCylinder->bAbsoluteLocation = true;// 4.23 Code
	//TeleportCylinder->bAbsoluteRotation = true;// 4.23 Code
	//TeleportCylinder->bAbsoluteScale = true;// 4.23 Code
	...
	RoomScaleMesh->SetUsingAbsoluteRotation(true);// 4.24 Update
	RoomScaleMesh->SetUsingAbsoluteScale(true);// 4.24 Update
	//RoomScaleMesh->bAbsoluteRotation = true;// 4.23 Code
	//RoomScaleMesh->bAbsoluteScale = true;// 4.23 Code
